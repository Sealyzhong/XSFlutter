...
exports.MyPullToRefreshEmptyWidgetPage = void 0;
const icon_data_1 = require("demo/model/icon_data");
const fs = require("flutter_sdk");
const tl = require("flutter_third_library");
class MyPullToRefreshEmptyWidgetPage extends fs.StatefulWidget {
    createState() {
...
exports.MyPullToRefreshEmptyWidgetPage = MyPullToRefreshEmptyWidgetPage;
    ...
    build(context) {
        ...
        return fs.Scaffold.new({
            appBar: fs.AppBar.new({
                title: fs.Text.new("空视图"),
            }),
            body: tl.PullToRefreshRefresher.new({
                controller: this.refreshController,
                enablePullDown: true,
                enablePullUp: true,
                header: tl.PullToRefreshMaterialClassicHeader.new(),
                ...
                child: this._count <= 0 ? fs.EmptyDataWidget.new() : fs.ListView.builder({
