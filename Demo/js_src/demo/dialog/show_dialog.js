...
exports.MyShowDialogPage = void 0;
const section_title_1 = require("demo/widgets/section_title");
const fs = require("flutter_sdk");
class MyShowDialogPage extends fs.StatelessWidget {
    constructor() {
        super(...arguments);
        this._style = new fs.TextStyle({ fontSize: 24, fontWeight: fs.FontWeight.bold });
        this.menuKey = new fs.BindKey();
        this.menuKey1 = new fs.BindKey();
...
exports.MyShowDialogPage = MyShowDialogPage;
