...
class ListViewItem extends JSStatelessWidget {
  ...
  build(context) {
    ...
    let example = require("./app_demo/widget_examples/" + prefix + "/" + title + ".js");
