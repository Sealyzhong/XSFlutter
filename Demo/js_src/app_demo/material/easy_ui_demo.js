                ...
                new Row({
                    ...
                    children: [
                        new FlatButton({
                            ...
                            onPressed: function() {
                                JSLog.log('Flat Button Pressed');
                            },
                            onHighlightChanged: function(args) {
                                JSLog.log('Flat Button onHighlightChanged');
                            }
                        ...
                        new RaisedButton({
                            ...
                            onPressed: function() {
                                JSLog.log('Raised Button Pressed');
                            }
                            // color: new Color(0x60000000),
                        }),
                        new FloatingActionButton({
                            ...
                            onPressed: function() {
                                JSLog.log('Floating Action Button Pressed');
                            }
                        }),
                        new IconButton({
                            icon: new Icon(new IconData(0xe815, {fontFamily: 'MaterialIcons'})),
                            onPressed: function() {
                                JSLog.log('Icon Button Pressed');
                            }
                        }),
                    ],
                }),
                    ...
                    children: [
                        ...
                        new PopupMenuButton({
                            onSelected: function(args) {
                                JSLog.log('more button pressed, index ' + args);
                            },
                        ...
                        new ButtonBar({
                            ...
                            children:[
                                new RaisedButton({
                                    ...
                                    onPressed: function() {
                                        JSLog.log('Button Bar 1 pressed');
                                    }
                                }),
                                new RaisedButton({
                                    child: new Text('Button Bar 2'),
                                    onPressed: function() {
                                        JSLog.log('Button Bar 2 pressed');
                                    }
                                })
                            ]
                        })
            ...
            child: new Column({
                children:[
                    new Container({
                        ...
                        child: new TextField({
                            ...
                            onSubmitted: function (args) {
                                JSLog.log('number onSubmitted');
                            },
                            decoration: new InputDecoration({
                                labelText: 'placeholder'
                            }),
                            onChanged: function(args) {
                                JSLog.log('number onChanged');
                            }
                        })
                    }),
                    new SizedBox({
                    ...
                    new TextField({
                        ...
                        onSubmitted: function (args) {
                            JSLog.log('email onSubmitted');
                        },
                        onChanged: function(args) {
                            JSLog.log('email onChanged');
                        }
                    })
                ]
            })
                ...
                children:[
                    new Container({
                        ...
                        child: new TextFormField({
                            ...
                            onFieldSubmitted: function (args) {
                                JSLog.log('email onFieldSubmitted');
                            }
                        })
                    }),
                    new SizedBox({
                    ...
                    new Container({
                        ...
                        child: new TextFormField({
                            ...
                            onFieldSubmitted: function (args) {
                                JSLog.log('phone onFieldSubmitted');
                            }
                        })
                    })
                ]
