...
class CustomJSApi {
  ...
  static Map<String, Function> funName2Fun = {
    "getMyAppName": (CustomJSApi mirrorObj, {String platform, String v}) => mirrorObj.getMyAppName(platform, v: v),
    "getMyData": (CustomJSApi mirrorObj, {String sameInfo, String v, int v2}) => mirrorObj.getMyData(sameInfo, v: v, v2: v2)
  };
...
class CustomJSApiProxy extends XSJsonObjProxy {
  ...
  @override
  CustomJSApi constructor(dynamic bo, Map<String, dynamic> jsonMap, {dynamic context}) {
    //2. 修改为自己的类
