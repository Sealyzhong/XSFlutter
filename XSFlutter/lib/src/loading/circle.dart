...
class XSLoadingCircle extends StatefulWidget {
  const XSLoadingCircle({
    Key key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  _XSLoadingCircleState createState() => _XSLoadingCircleState();
}

class _XSLoadingCircleState extends State<XSLoadingCircle> with SingleTickerProviderStateMixin, TickerProviderStateMixin {
              ...
              child: Transform(
                ...
                child: Align(
                  ...
                  child: ScaleTransition(
                    scale: XSLoadingDelayTween(begin: 0.0, end: 1.0, delay: delays[index]).animate(_controller),
