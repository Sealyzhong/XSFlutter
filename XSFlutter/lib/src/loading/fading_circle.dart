...
class XSLoadingFadingCircle extends StatefulWidget {
  const XSLoadingFadingCircle({
    Key key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
              ...
              child: Transform(
                ...
                child: Align(
                  ...
                  child: FadeTransition(
                    opacity: XSLoadingDelayTween(begin: 0.0, end: 1.0, delay: delays[i]).animate(_controller),
