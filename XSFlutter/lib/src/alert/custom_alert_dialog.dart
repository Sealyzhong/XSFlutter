...
* 提示框动画类型
* */
enum XSCustomAlertDialogAnimationType {
  fromRight,
  fromLeft,
  fromTop,
  fromBottom,
...
class XSCustomAlertDialogStyle {
  ...
  const XSCustomAlertDialogStyle({
    this.animationType = XSCustomAlertDialogAnimationType.shrink,
    this.animationDuration = const Duration(milliseconds: 200),
    this.alertBorder,
    this.isCloseButton = false,
    this.isOverlayTapDismiss = false,
    this.backgroundColor,
    this.overlayColor = const Color.fromARGB(125, 0, 0, 0),
  ...
  * */
  ...
  Widget _buildDialog() {
    return AlertDialog(
      ...
      title: Stack(
          children: <Widget>[
            style.isCloseButton?Align(alignment: Alignment.topRight,child: IconButton(onPressed: () => Navigator.pop(context), icon: Icon(Icons.close,color: Colors.grey,),),):Container(),
            Container(
  ...
  * */
  ...
  _showAnimation(animation, secondaryAnimation, child) {
    if (style.animationType == XSCustomAlertDialogAnimationType.fromRight) {
      return XSCustomAlertDialogAnimationTransition.fromRight(
      ...
      return XSCustomAlertDialogAnimationTransition.fromBottom(
          animation, secondaryAnimation, child);
