...
import com.xsyx.xsflutter.framework.utils.ClassUtils;
...
public class JSModule {
    ...
    public static String resolveModuleAsDirectory(String moduleClassName, V8Object runtime) {
        ...
        if (new File(path).exists()) {
            String filecontents = FileUtils.getScriptFromFS(XSFlutterPlugin.getInstance().mFlutterPluginBinding.getApplicationContext(), path);
    ...
    public static V8Object require(String moduleClassName, String fullModulePath, boolean fromAsset) {
        return require(moduleClassName, fullModulePath, XSJSExecutor.runtime, fromAsset);
    }
    ...
    public static V8Object require(String moduleClassName, String fullModulePath, V8Object context, boolean fromAsset) {
        ...
        String script = FileUtils.getScriptFromPath(XSFlutterPlugin.getInstance().mFlutterPluginBinding.getApplicationContext(), fullModulePath, fromAsset);
