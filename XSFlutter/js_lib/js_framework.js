...
exports.XSJSWidgetHelper = exports.JSStatelessWidget = exports.JSStatefulWidget = exports.JSBaseWidget = exports.JSWidgetState = exports.JSFluterWidget = exports.JSBaseClass = exports.JSCallArgs = exports.JSWidgetMirrorMgr = exports.JSWidgetMgr = exports.JSWidgetTree = exports.JSBuildContext = exports.JSCallbackMgr = exports.JSMethodCall = exports.JSLog = exports.JSFramework = void 0;
// @ts-ignore：dart_sdk
...
class JSFluterWidget extends JSBaseClass {
    //在生成json前调用
...
exports.JSFluterWidget = JSFluterWidget;
//****** JS Widget State ******
class JSWidgetState {
    constructor() {
        this.widget = null;
...
class XSJSWidgetHelper {
    ...
    invokeCallback(buildWidgetDataSeq, callID, args) {
        ...
        if (this.widget.currentWidgetTree && this.widget.currentWidgetTree.buildWidgetDataSeq != buildWidgetDataSeq) {
            JSLog.error("XSJSWidget:invokeCallback:this.widget.currentWidgetTree.buildWidgetDataSeq(" + this.widget.currentWidgetTree.buildWidgetDataSeq + ")  != buildWidgetDataSeq(" + buildWidgetDataSeq + ") " +
                " callID: " +
                callID);
            if (this.widget.preWidgetTree && this.widget.preWidgetTree.buildWidgetDataSeq == buildWidgetDataSeq) {
                JSLog.error("XSJSWidget:invokeCallback:this.widget.preWidgetTree.buildWidgetDataSeq(" + this.widget.preWidgetTree.buildWidgetDataSeq + ")  == buildWidgetDataSeq(" + buildWidgetDataSeq + ") " +
                    " callID: " +
                    callID);
            }
            if (this.widget.buildingWidgetTree && this.widget.buildingWidgetTree.buildWidgetDataSeq == buildWidgetDataSeq) {
                JSLog.error("XSJSWidget:invokeCallback:this.widget.buildingWidgetTree.buildWidgetDataSeq(" + this.widget.buildingWidgetTree.buildWidgetDataSeq + ")  == buildWidgetDataSeq(" + buildWidgetDataSeq + ") " +
                    " callID: " +
                    callID);
            }
            return null;
        ...
        if (this.widget.currentWidgetTree && this.widget.currentWidgetTree.findCallback(callID)) {
            ...
            //容错处理
            JSLog.error("XSJSWidget:invokeCallback: 容错搜索所有BuildTree，this.widget.buildingWidgetTree.buildWidgetDataSeq(" + this.widget.buildingWidgetTree.buildWidgetDataSeq + ")  == buildWidgetDataSeq(" + buildWidgetDataSeq + ") " +
                " callID: " +
                callID);
            for (let seq in this.widget.buildSeq2WTreeMap) {
...
exports.XSJSWidgetHelper = XSJSWidgetHelper;
