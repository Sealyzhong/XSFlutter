...
let{ XSEncodeParam } = require("./js_flutter_basic_types.js");
    ...
    _invokeMethod(T, method, opts) {
        ...
        return async.async(
            ...
            function* invokeMethod() {
                ...
                function xsflutter_MethodChannel_invokeMethod(channelName) {
                    let completer = async.Completer$(T).new();
                    xs_jsbridge_MethodChannel_invokeMethod(
                        channelName,
                        method,
                        XSEncodeParam.encodeParam($arguments),
                        dart.fn(value => {
                            core.print("xs_jsbridge_MethodChannel_invokeMethod: callback " + value);
                ...
                let result = yield xsflutter_MethodChannel_invokeMethod(this.name);
                if (result == null) {
                    dart.throw(
...
class FakeStreamController {
    ...
    listen(onData, opts) {
        ...
        xs_jsbridge_EventChannel_receiveBroadcastStream_listen(this.channelName, this.streamParam, onData, onError, onDone, cancelOnError);
    }
};
...
let xs_platform_channel = Object.create(dart.library);
xs_platform_channel.XSMethodChannel = class XSMethodChannel extends platform_channel.MethodChannel {
    ...
    async invokeMethod(method, $arguments) {
        ...
        let promiseResult = new Promise(function (resolve, reject) {
            ...
            xs_jsbridge_MethodChannel_invokeMethod(this.name, method, XSEncodeParam.encodeParam($arguments), function (value) {
                if (value != null) {
                    resolve(value);
                } else {
                    reject(null);
    ...
    setMethodCallHandler(handler) {
        //xs_jsbridge_MethodChannel_setMethodCallHandler(this.name, handler);
    }

}


xs_platform_channel.MethodCall = class MethodCall extends core.Object {
...
exports.MethodChannel = xs_platform_channel.XSMethodChannel;
